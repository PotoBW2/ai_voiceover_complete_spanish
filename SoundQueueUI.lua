...
function SoundQueueUI:InitMover()
    ...
    self.frame.mover:HookScript("OnEnter", function(self)
        ...
        GameTooltip:SetText("Mover el marco", HIGHLIGHT_FONT_COLOR.r, HIGHLIGHT_FONT_COLOR.g, HIGHLIGHT_FONT_COLOR.b)
        GameTooltip:AddLine("La posición del marco se puede bloquear en la configuración.", NORMAL_FONT_COLOR.r, NORMAL_FONT_COLOR.g, NORMAL_FONT_COLOR.b, 1)
        GameTooltip:Show()
    end)
